          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
            ...
            <div className="text-left lg:col-span-7">
              ...
              <p className="mt-6 max-w-xl text-base text-muted-foreground sm:text-lg leading-relaxed">
                Unlock deep insights into your dietary health. Snap a photo of any meal to instantly identify South & North Indian dishes, log nutritional stats, and receive custom meal recommendations tailored to your BMI.
              </p>
              ...
              <div className="relative w-full max-w-[380px] rounded-2xl border border-border/60 bg-gradient-to-b from-card to-background p-4 shadow-2xl">
                <div className="mb-3 flex items-center justify-between border-b border-border/40 pb-2.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-foreground tracking-wide font-mono">NutriAI Recognition Engine</span>
                  </div>
                  <span className="text-[10px] bg-secondary px-2 py-0.5 rounded text-muted-foreground font-mono">LIVE_SCAN</span>
                </div>
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-background/95 backdrop-blur-md rounded-lg p-2.5 border border-border flex items-center justify-between shadow-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-[9px] text-muted-foreground font-mono">Cuisine Match: 98.7%</div>
                      </div>
                    </div>
                    <span className="rounded bg-primary/20 px-1.5 py-0.5 text-[9px] font-bold text-primary">SOUTH_NORTH</span>
                  </div>
                </div>
                ...
                <div className="mt-3.5 grid grid-cols-3 gap-2.5">
                  <div className="rounded-lg bg-secondary/30 p-2 text-center border border-border/30">
                    <div className="text-[9px] text-muted-foreground uppercase tracking-wider font-semibold">Calories</div>
                    <div className="text-xs font-bold text-foreground mt-0.5">520 kcal</div>
                  </div>
                  <div className="rounded-lg bg-secondary/30 p-2 text-center border border-border/30">
                    <div className="text-[9px] text-muted-foreground uppercase tracking-wider font-semibold">Protein</div>
                    <div className="text-xs font-bold text-emerald-500 mt-0.5">26.5 g</div>
                  </div>
                  <div className="rounded-lg bg-secondary/30 p-2 text-center border border-border/30">
                    <div className="text-[9px] text-muted-foreground uppercase tracking-wider font-semibold">Carbs</div>
            ...
            {sampleFoods.map((food) => (
              ...
              >
                ...
                <div className="p-3.5 flex flex-col flex-grow justify-between">
                  <div>
                    <h3 className="text-sm font-semibold text-foreground tracking-tight line-clamp-1">{food.name}</h3>
                    <p className="text-[11px] text-muted-foreground mt-0.5 font-medium">{food.calories} cal / serving</p>
                  </div>
                  <div className="mt-3.5 pt-2 border-t border-border/40 flex justify-between items-center">
                    <span className="text-[10px] text-primary font-bold tracking-tight">Tap to analyze</span>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => {
              ...
              return (
                ...
                >
                  <div className="mb-4">
                    <div className={`mb-3.5 flex h-10 w-10 items-center justify-center rounded-lg ${feature.bg} ${feature.color}`}>
                      <feature.icon className="h-5 w-5" />
                    </div>
                    <h3 className="mb-1.5 text-sm font-semibold text-foreground flex items-center gap-1.5">
                      {feature.title}
                      {isRecognition && (
                        <span className="inline-block px-1.5 py-0.5 text-[9px] font-bold text-primary bg-primary/10 rounded">LIVE SCAN</span>
                      )}
                    </h3>
                  ...
                  {isRecs && (
                    <div className="mt-1 rounded-lg border border-border/30 bg-secondary/15 p-2.5 space-y-2 select-none text-[11px]">
                      <div className="text-[10px] uppercase font-bold text-muted-foreground tracking-wider font-mono">Smart Indian Switch</div>
                      <div className="flex items-center justify-between border border-destructive/20 bg-destructive/5 rounded p-1">
                        ...
                        <span className="text-destructive font-mono text-[9px] font-bold">HIGH GI</span>
                      </div>
                      <div className="flex items-center justify-between border border-emerald-500/25 bg-emerald-500/5 rounded p-1">
                        ...
                        <span className="text-emerald-500 font-mono text-[9px] font-bold">BEST MATCH</span>
                      </div>
                    </div>
                  )}
                  ...
                  {isBMI && (
                    <div className="mt-1 rounded-lg border border-border/30 bg-secondary/20 p-2.5 select-none space-y-1.5">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-xs font-black text-emerald-500 font-mono bg-emerald-500/10 px-1.5 py-0.2 rounded">22.4 (Normal)</span>
                      </div>
                  ...
                  {isWater && (
                    <div className="mt-1 rounded-lg border border-border/30 bg-secondary/20 p-2.5 select-none space-y-2">
                      <div className="flex justify-between items-center font-mono">
                        ...
                        <span className="text-[11px] font-bold text-neon-blue">1,750 / 2,500 ml</span>
                      </div>
                      {/* Cups row */}
                  ...
                  {isWeight && (
                    <div className="mt-1 rounded-lg border border-border/30 bg-secondary/20 p-2.5 select-none space-y-1">
                      <div className="flex justify-between items-center text-[10px]">
                        ...
                        <span className="font-extrabold text-foreground font-mono">68.4 kg (-1.2kg)</span>
                      </div>
